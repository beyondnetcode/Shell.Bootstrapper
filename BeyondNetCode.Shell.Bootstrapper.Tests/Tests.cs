...
using BeyondNetCode.Shell.Bootstrapper.Tests.Impl;
using BeyondNetCode.Shell.Bootstrapper.DependencyInjection;
using BeyondNetCode.Shell.Bootstrapper.AutoMapper;
using BeyondNetCode.Shell.Bootstrapper.Observability;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using Shouldly;
using System.Linq;

namespace BeyondNetCode.Shell.Bootstrapper.Tests
{
    [TestClass]
    public class Tests
    {
        ...
        public void Configure_AutoMapperBootstrapper_ShouldCreateValidMapper()
        {
            ...
            var mapperConfig = new MapperConfiguration(autoMapperBootstrapper.Result);
